...
/**
 * Each instance of this class represents an departure portal that is part of a wormhole.
 * @invar| getWormholes().stream().allMatch(a-> a != null && a.getDeparturePortal() == this)
 */
public class DeparturePortal {
	...
	/**
	 * @invar | getWormholesInternal().stream().allMatch(a-> a.getDeparturePortalInternal()==this)
